class AddDeviseToUsuarios < ActiveRecord::Migration[7.1]
  def change
    ...
    add_index :usuarios, :email,                unique: true       # Índice único para el correo electrónico
    add_index :usuarios, :reset_password_token, unique: true       # Índice único para el token de recuperación
  end
end
